...
class Carte:
    ...
    def obtenir_cases_joueur(self, joueur):
        ...
        dictionnaire_cases_joueur = {}
        for case in self.cases.values():
            if case.appartenance == joueur:
                dictionnaire_cases_joueur[case.coordonnees] = case
        return dictionnaire_cases_joueur
    ...
    def obtenir_cases_ennemies(self, joueur):
        ...
        dictionnaire_cases_enemies = {}
        for case in self.cases.values():
            if case.appartenance != joueur:
                dictionnaire_cases_enemies[case.coordonnees] = case
        return dictionnaire_cases_enemies
    ...
    def obtenir_cases_non_pleines(self, joueur):
        ...
        dictionnaire_cases_non_pleines = {}
        cases_joueur = self.obtenir_cases_joueur(joueur)
        liste_cases_joueur = list(cases_joueur.values())
        for case in liste_cases_joueur:
            if case.est_pleine() is False:
                dictionnaire_cases_non_pleines[case.coordonnees] = case
        return dictionnaire_cases_non_pleines
    ...
    def cases_disponibles_pour_defense(self, joueur, case_attaque):
        ...
        dictionnaire_cases_disponible_pour_defense = {}
        for case in case_attaque.voisins:
            if case.appartenance != joueur:
                dictionnaire_cases_disponible_pour_defense[case.coordonnees] = case
        return dictionnaire_cases_disponible_pour_defense
