...
class Case:
    ...
    def est_pleine(self):
        ...
        nombre_de_des_dans_case = self.nombre_de_des()
        if nombre_de_des_dans_case == MAX_DES_PAR_CASE:
            case_pleine = True
        else:
            case_pleine = False
        return case_pleine
    ...
    def lancer_des(self):
        ...
        somme_des_des_lancer = 0
        for de in self.des:
            somme_des_des_lancer += de.lancer()
        afficher("--> {}".format(somme_des_des_lancer))
        return somme_des_des_lancer
